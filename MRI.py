...
pneumonia_model = pickle.load(open(r"C:\RPC\pneumonia_model.sav", 'rb'))
...
st.sidebar.image(r'C:\GEN AI-PPROJECT\Frontend\sidebar_image.png', width=250)
...
def alzheimer():
    ...
    if uploaded_file is not None:
        ...
        if index == 0:
            result="Sorry buddy you have Alzheimer's.Most probably you have mild Alzheimer's disease."
            # st.write(result)
        elif index == 1:
            result="Sorry buddy you have Alzheimer's.Most probably you have moderate Alzheimer's disease."
            # st.write(result)
        elif index == 2:
            result="Sorry buddy you have Alzheimer's.Most probably you don't have Alzheimer's disease."
            # st.write(result)
        elif index == 3:
            result="Sorry buddy you have Alzheimer's.Most probably you have very mild Alzheimer's disease."
            # st.write(result)
...
def tumor():
    ...
    if uploaded_file is not None:
        ...
        index = prediction.argmax()
        if index == 0:
            result="Sorry Buddy,You have a Tumor.Most probably you have Glioma Tumor."
            # st.write(result)
        elif index == 1:
            result="Sorry Buddy,You have a Tumor.Most probably you have Meningioma Tumor."
            # st.write(result)
        elif index==2:
            ...
            result="Sorry Buddy,You have a Tumor.Most probably you have Pituitary Tumor."
            # st.write(result)
    return st.success(result)    
